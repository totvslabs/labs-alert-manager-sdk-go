...
type _PaginationSchema PaginationSchema
...
func (o *PaginationSchema) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPaginationSchema := _PaginationSchema{}

	err = json.Unmarshal(bytes, &varPaginationSchema)

	if err != nil {
		return err
	}

	*o = PaginationSchema(varPaginationSchema)
